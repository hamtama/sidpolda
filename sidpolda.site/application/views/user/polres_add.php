        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="polres/add" method="post" id="polres_form" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group row pr-2">
                                    ...
                                    <div class="custom-file col-sm-9 pb-5">
                                        ...
                                        <label class="custom-file-label" id="image" for="file_image">Choose file...</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="tel" id="kontak" name="kontak" class="form-control" maxlength="14" />
