<script text="text/javascript">
    ...
    $('.tambah').click(function() {
        ...
        $('#myLargeModalLabel').text('Tambah Data Users');
        myModal.toggle();
    ...
    $('.editBtn').click(function() {
        ...
        $('#myLargeModalLabel').text('Edit Data Level');
        myModal.toggle();
        $("#batal").on('click', function() {
            myModal.toggle();
        });
    ...
    $('#Medium-modal').on('hidden.bs.modal', function() {
        $('#nama,#email, #username, #password, #password2, #role').removeClass('is-valid');
        $('#nama,#email, #username, #password, #password2, #role').removeClass('is-invalid');
        $('#nama,#email, #username, #password, #password2, #role').val('');
